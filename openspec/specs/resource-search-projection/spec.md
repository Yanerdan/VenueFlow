# Resource Search Projection Specification

## Purpose

Define reliable publication, bounded search, failure degradation, and safe rebuild behavior for
the Elasticsearch resource projection.
