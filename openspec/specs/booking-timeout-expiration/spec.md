# Booking Timeout Expiration Specification

## Purpose

Define Booking-owned pending deadlines, explicit confirmation, recoverable timeout leases,
proven capacity release, expiration events, lifecycle race safety, and verification boundaries.
