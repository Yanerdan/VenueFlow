...
- 管理端：运营总览与报表、申请详情、直接或两级审批、审批轨迹、人员目录与角色管理、审批人选择、签到核销、资源发布和开放时段管理。
...
6. 在“人员目录”将测试账号设为审批人，再在资源卡片中从人员列表指定该审批人；测试结束后将账号恢复为申请人。

完整说明见 [校园管理端运行手册](docs/runbook/campus-administration.md)。

资源管理支持配置归属部门，并从合格人员目录选择直接审批或固定两级审批。新预约会保存审批链快照，普通审批人只接收当前节点分配给自己的申请，系统管理员保留全局管理视图；申请人和管理人员均可查看有序审批轨迹。
