...
Resource Service SHALL expose a versioned mutation for the resource name, description, location,
category, and capacity, SHALL reapply catalog validation, and SHALL reject stale versions without
partially changing the resource.
