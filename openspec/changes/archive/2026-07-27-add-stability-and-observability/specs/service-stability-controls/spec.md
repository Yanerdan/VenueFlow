...
Booking writes MUST only reject/queue on overload and MUST NOT return a fabricated success,
repeat a capacity write, or silently fall back to stale state.
