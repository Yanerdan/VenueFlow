...
- 申请人端：注册登录、校园身份资料维护、资源检索、时段选择、提交/撤回申请、进度与消息查询。
- 管理端：运营总览、具名申请审批、人员目录、签到核销、资源发布和开放时段管理。
...
1. 在申请人端注册账号，填写学工号、身份类型和院系，选择资源与开放时段并提交申请。
2. 使用演示管理员登录，在“人员目录”确认人员资料，再进入“申请审批”审批具名申请。
